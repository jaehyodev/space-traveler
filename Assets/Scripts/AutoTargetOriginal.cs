...
//무기와 직선 상 가장 가까운 적을 공격한다
public class AutoTargetOriginal : MonoBehaviour
{
    ...
    private void DetectTarget()
    {
        if (target == null)
        {
            ...
            {
                float distanceToEnemies = Vector3.Distance(weapon.transform.position, enemy.transform.position); // 나와 적과의 거리
